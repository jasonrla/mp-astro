...
export const GET: APIRoute = async ({ params }) => {
  ...
  try {
    ...
    const formattedOrder = {
      ...
      total: order.total,
      status: order.payment_status, // Or order.status depending on what we want to show
      ...
      customer: {
        ...
        city: "Lima", // Placeholder as city isn't explicitly stored in schema provided, or extract from address
